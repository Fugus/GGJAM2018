...
{
    [ExecuteInEditMode]
    public class JaquotCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            m_RollUp = m_RollSpeed > 0 ? Vector3.Slerp(m_RollUp, targetUp, m_RollSpeed*deltaTime) : -m_Target.GetComponent<JaquotFakeGravity>().fakeGravityDirection;
